...
#define RSSTATUS_RED FSlateColor(FLinearColor{ 1.0, 0.0, 0.0 })
#define RSSTATUS_GREEN FSlateColor(FLinearColor{ 0.0, 1.0, 0.0 })
#define RSSTATUS_ORANGE FSlateColor(FLinearColor{ 1.0, 0.5, 0.0 })
